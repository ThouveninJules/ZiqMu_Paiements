    ...
    class CompteDao 
    {
        ...
        public  List<Compte> getComptes(Client cl)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    Compte c = new CompteEpargne(numCompte, cl);
                    c.crediter(solde);
                    ((CompteEpargne)c).Taux = taux;
        ...
        public void updateSolde(Compte c)
        {
            ...
            try
            {
                ...
                Ocom = maConnexionSql.reqExec("Update compte c set c.solde ="+ c.Solde +" where c.numCompte = " + c.Num);
        ...
        public void updateDecouvert(CompteCourant c)
        {
            ...
            try
            {
                ...
                Ocom = maConnexionSql.reqExec("Update comptecourant c set c.decouvert =" + c.Decouv + " where c.numCompte = " + c.Num);
                Ocom.ExecuteNonQuery();
        ...
        public void updateTaux(CompteEpargne c)
        {
            try
            {
                Ocom = maConnexionSql.reqExec("Update compteepargne c set c.tauxInteret =" + c.Taux + " where c.numCompte = " + c.Num);
                Ocom.ExecuteNonQuery();
            }
